...
__decorate([
    (0, common_1.Get)('clothes'),
    __param(0, (0, common_1.Query)('city')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], WeatherController.prototype, "getClothes", null);
__decorate([
    (0, common_1.Get)('clotheswfa'),
    __param(0, (0, common_1.Query)('formalidad')),
    __param(1, (0, common_1.Query)('edad')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", Promise)
], WeatherController.prototype, "getClothesWFA", null);
